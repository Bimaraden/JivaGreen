...
import { auth, db, googleProvider } from '../src/firebase.ts';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-dark p-20 flex-col justify-between relative overflow-hidden h-full">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-5 mb-20">
            <div className="w-20 h-20 flex items-center justify-center rounded-[2rem] shadow-2xl relative overflow-hidden group hover:scale-110 transition-transform duration-500">
               <img src="/logo.png" className="w-full h-full object-contain" alt="Jivagreen Logo" referrerPolicy="no-referrer" />
            </div>
            <span className="text-4xl font-black text-white tracking-tighter italic">Jiva<span className="text-primary italic">green.</span></span>
          </div>
          ...
          >
            ...
            <p className="text-white/40 text-xl max-w-md leading-relaxed font-medium tracking-tight">
              Memulihkan lingkungan kita melalui pengelolaan limbah berbasis AI dan ekonomi sirkular yang cerdas.
            </p>
          </motion.div>
        </div>
